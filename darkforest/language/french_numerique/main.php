...
define("THEME_PSEUDO",					"Identifiant");
define("THEME_DESC_PSEUDO",				"Saisissez votre identifiant");
define("THEME_PASSWORD",				"Password");
define("THEME_DESC_PASSWORD",			"Saisissez votre mot de passe");
define("THEME_LOSTACCOUNT",				"Perdu le mot de passe ?");
define("THEME_OK",						"OK");

define("THEME_UEDITPROFILE",			"Editer son profil");
define("THEME_UEDITAVATAR",				"Changer son image");
define("THEME_UEDITPASSWORD",			"Modifier son mot de passe");
define("THEME_UPOSTS",					"Nbr de Contribution(s)");
